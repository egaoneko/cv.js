...
(function (CHANNEL_TYPE) {
    CHANNEL_TYPE[CHANNEL_TYPE["RED"] = 0] = "RED";
    CHANNEL_TYPE[CHANNEL_TYPE["GREEN"] = 1] = "GREEN";
    CHANNEL_TYPE[CHANNEL_TYPE["BLUE"] = 2] = "BLUE";
})(CHANNEL_TYPE = exports.CHANNEL_TYPE || (exports.CHANNEL_TYPE = {}));
var CHANNEL_PRESENT_FLAG;
(function (CHANNEL_PRESENT_FLAG) {
    CHANNEL_PRESENT_FLAG[CHANNEL_PRESENT_FLAG["SINGLE"] = 0] = "SINGLE";
    CHANNEL_PRESENT_FLAG[CHANNEL_PRESENT_FLAG["GRAYSCALE"] = 1] = "GRAYSCALE";
})(CHANNEL_PRESENT_FLAG = exports.CHANNEL_PRESENT_FLAG || (exports.CHANNEL_PRESENT_FLAG = {}));
...
exports.err = err;
function compPixel(a, b) {
    var avgA = (a.r + a.g + a.b) / 3;
    var avgB = (b.r + b.g + b.b) / 3;
    return avgA - avgB;
}
exports.compPixel = compPixel;
...
function getContext2D(canvas) {
    if (!canvas) {
        common_1.err('IInvalid canvas');
    }
    return canvas.getContext('2d');
}
exports.getContext2D = getContext2D;
function setCanvasByImage(canvas, image) {
    if (!canvas) {
        common_1.err('IInvalid canvas');
    }
    if (!image) {
        common_1.err('Invalid image');
    }
    canvas.width = image.width;
    canvas.height = image.height;
    getContext2D(canvas).drawImage(image, 0, 0);
}
exports.setCanvasByImage = setCanvasByImage;
...
var CVImage = function () {
    function CVImage(image) {
        this.cvs = document.createElement('canvas');
        this.ctx = CanvasHelper_1.getContext2D(this.cvs);
        if (!image) {
            common_1.err('Invalid image');
        }
        this.img = image;
        CanvasHelper_1.setCanvasByImage(this.cvs, image);
        this.imageData = this.ctx.getImageData(0, 0, this.width, this.height);
    }
    Object.defineProperty(CVImage.prototype, "image", {
        get: function get() {
            var image = new Image();
    ...
    Object.defineProperty(CVImage.prototype, "canvas", {
        get: function get() {
            return this.cvs;
        },
        enumerable: true,
    ...
    Object.defineProperty(CVImage.prototype, "width", {
        get: function get() {
    ...
    Object.defineProperty(CVImage.prototype, "height", {
        get: function get() {
    ...
    CVImage.prototype.getPixels = function () {
        return this.imageData.data.slice();
    };
    CVImage.prototype.convolve = function (action) {
        var pixels = this.getPixels();
        for (var idx = 0; idx < pixels.length; idx += 4) {
            var _a = action(this.getPixelByIndex(pixels, idx)),
                r = _a.r,
                g = _a.g,
                b = _a.b,
                a = _a.a;
    ...
    CVImage.prototype.kernelConvolve = function (action, kernelSize, weights) {
        if (weights === void 0) {
            weights = [];
        }
        var pixels = this.getPixels();
        var originPixels = this.getPixels();
        if (kernelSize % 2 === 0) {
            common_1.err('Invalid kernelSize');
        }
        for (var x = 0; x < this.width; x += 1) {
            for (var y = 0; y < this.height; y += 1) {
                var idx = this.getPixelIndex(this.width, x, y, 0);
                var pixel = this.getPixelByIndex(pixels, idx);
                var kernel = this.getKernel(originPixels, kernelSize, x, y);
                var _a = action(pixel, kernel, kernelSize, weights),
                    r = _a.r,
                    g = _a.g,
                    b = _a.b,
                    a = _a.a;
    ...
    CVImage.prototype.multiConvolve = function (other, action, weight1, weight2) {
        var thisPixels = this.getPixels();
        var otherPixels = other.getPixels();
        for (var idx = 0; idx < thisPixels.length; idx += 4) {
            var _a = action(this.getPixelByIndex(thisPixels, idx), this.getPixelByIndex(otherPixels, idx), weight1, weight2),
                r = _a.r,
                g = _a.g,
                b = _a.b,
                a = _a.a;
    ...
    CVImage.prototype.getPixelByIndex = function (pixels, index) {
    ...
    CVImage.prototype.setPixels = function (pixels) {
        var imageData = this.ctx.createImageData(this.width, this.height);
        imageData.data.set(pixels);
        this.ctx.putImageData(imageData, 0, 0);
    };
    CVImage.prototype.getPixelIndex = function (width, x, y, channel) {
        return (y * width + x) * 4 + channel;
    };
    CVImage.prototype.getKernel = function (pixels, kernelSize, x, y) {
        var kernel = [];
        var offset = Math.floor(kernelSize >> 1);
        var start = -offset;
        var end = kernelSize - offset;
        for (var i = start; i < end; i += 1) {
            for (var j = start; j < end; j += 1) {
                var cx = Math.min(this.width - 1, Math.max(0, x + i));
                var cy = Math.min(this.height - 1, Math.max(0, y + j));
                var idx = this.getPixelIndex(this.width, cx, cy, 0);
...
var Cache = function () {
    ...
    Cache.prototype.add = function (key, file) {
...
},{"./errorObject":196}],45:[function(require,module,exports) {
"use strict";
...
},{"./util/isArray":192,"./util/isObject":193,"./util/isFunction":194,"./util/tryCatch":195,"./util/errorObject":196,"./util/UnsubscriptionError":45}],189:[function(require,module,exports) {
"use strict";
exports.empty = {
    closed: true,
    next: function (value) { },
...
},{"../util/root":190}],34:[function(require,module,exports) {
"use strict";
var __extends = (this && this.__extends) || function (d, b) {
    for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p];
    function __() { this.constructor = d; }
...
},{"./util/isFunction":194,"./Subscription":33,"./Observer":189,"./symbol/rxSubscriber":55}],191:[function(require,module,exports) {
"use strict";
...
},{"../Subscriber":34,"../symbol/rxSubscriber":55,"../Observer":189}],57:[function(require,module,exports) {
"use strict";
var root_1 = require('../util/root');
...
},{"../util/root":190}],296:[function(require,module,exports) {
"use strict";
...
},{"./noop":296}],32:[function(require,module,exports) {
"use strict";
var root_1 = require('./util/root');
...
},{"./Subscription":33}],31:[function(require,module,exports) {
"use strict";
var __extends = (this && this.__extends) || function (d, b) {
    for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p];
    function __() { this.constructor = d; }
...
},{"../Observable":32,"../util/tryCatch":195,"../util/errorObject":196,"../AsyncSubject":35}],308:[function(require,module,exports) {
"use strict";
...
},{"../Observable":32}],446:[function(require,module,exports) {
"use strict";
var __extends = (this && this.__extends) || function (d, b) {
    for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p];
    function __() { this.constructor = d; }
...
},{"../Observable":32}],438:[function(require,module,exports) {
"use strict";
var __extends = (this && this.__extends) || function (d, b) {
    for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p];
    function __() { this.constructor = d; }
...
},{"../Observable":32,"./ScalarObservable":447,"./EmptyObservable":446,"../util/isScheduler":437}],435:[function(require,module,exports) {
"use strict";
var __extends = (this && this.__extends) || function (d, b) {
    for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p];
    function __() { this.constructor = d; }
...
},{"./Subscriber":34}],474:[function(require,module,exports) {
"use strict";
...
},{"../util/root":190}],473:[function(require,module,exports) {
"use strict";
var __extends = (this && this.__extends) || function (d, b) {
    for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p];
    function __() { this.constructor = d; }
...
},{"./Subscriber":34}],436:[function(require,module,exports) {
"use strict";
...
},{"../observable/ArrayObservable":438,"../util/isArray":192,"../OuterSubscriber":435,"../util/subscribeToResult":436}],309:[function(require,module,exports) {
"use strict";
var isScheduler_1 = require('../util/isScheduler');
var isArray_1 = require('../util/isArray');
...
},{"../util/root":190,"../Observable":32}],477:[function(require,module,exports) {
"use strict";
var __extends = (this && this.__extends) || function (d, b) {
    for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p];
    function __() { this.constructor = d; }
...
},{"../util/root":190,"../Observable":32,"../symbol/iterator":56}],478:[function(require,module,exports) {
"use strict";
var __extends = (this && this.__extends) || function (d, b) {
    for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p];
    function __() { this.constructor = d; }
...
},{"../Observable":32,"./ScalarObservable":447,"./EmptyObservable":446}],38:[function(require,module,exports) {
"use strict";
var Observable_1 = require('./Observable');
/**
...
},{"./Observable":32}],197:[function(require,module,exports) {
"use strict";
var __extends = (this && this.__extends) || function (d, b) {
    for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p];
    function __() { this.constructor = d; }
...
},{"../Subscriber":34,"../Notification":38}],444:[function(require,module,exports) {
"use strict";
var __extends = (this && this.__extends) || function (d, b) {
    for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p];
    function __() { this.constructor = d; }
...
},{"./FromObservable":444}],242:[function(require,module,exports) {
"use strict";
var __extends = (this && this.__extends) || function (d, b) {
    for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p];
    function __() { this.constructor = d; }
...
},{"../util/subscribeToResult":436,"../OuterSubscriber":435}],443:[function(require,module,exports) {
"use strict";
function identity(x) {
    return x;
}
...
},{"./DeferObservable":457}],62:[function(require,module,exports) {
"use strict";
var Observable_1 = require('../../Observable');
...
},{"./EmptyObservable":446}],63:[function(require,module,exports) {
"use strict";
var Observable_1 = require('../../Observable');
var empty_1 = require('../../observable/empty');
Observable_1.Observable.empty = empty_1.empty;
//# sourceMappingURL=empty.js.map
},{"../../Observable":32,"../../observable/empty":314}],458:[function(require,module,exports) {
"use strict";
var __extends = (this && this.__extends) || function (d, b) {
    for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p];
    function __() { this.constructor = d; }
...
},{"../Observable":32,"./EmptyObservable":446,"../util/isArray":192,"../util/subscribeToResult":436,"../OuterSubscriber":435}],313:[function(require,module,exports) {
"use strict";
...
//# sourceMappingURL=from.js.map
},{"../../Observable":32,"../../observable/from":315}],459:[function(require,module,exports) {
"use strict";
var __extends = (this && this.__extends) || function (d, b) {
    for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p];
    function __() { this.constructor = d; }
...
},{"../Observable":32,"../util/tryCatch":195,"../util/isFunction":194,"../util/errorObject":196,"../Subscription":33}],316:[function(require,module,exports) {
"use strict";
var FromEventObservable_1 = require('./FromEventObservable');
exports.fromEvent = FromEventObservable_1.FromEventObservable.create;
//# sourceMappingURL=fromEvent.js.map
},{"./FromEventObservable":459}],66:[function(require,module,exports) {
"use strict";
var Observable_1 = require('../../Observable');
...
},{"../util/isArray":192}],453:[function(require,module,exports) {
"use strict";
var __extends = (this && this.__extends) || function (d, b) {
    for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p];
    function __() { this.constructor = d; }
...
},{"../util/root":190,"./Action":453}],449:[function(require,module,exports) {
"use strict";
/**
...
},{"../Scheduler":449}],52:[function(require,module,exports) {
"use strict";
...
},{"../Observable":32,"./ArrayObservable":438,"../util/isScheduler":437,"../operators/mergeAll":241}],72:[function(require,module,exports) {
"use strict";
var Observable_1 = require('../../Observable');
...
},{"../util/isArray":192,"../observable/ArrayObservable":438,"../OuterSubscriber":435,"../util/subscribeToResult":436}],73:[function(require,module,exports) {
"use strict";
var Observable_1 = require('../../Observable');
...
},{"../observable/FromObservable":444,"../util/isArray":192,"../OuterSubscriber":435,"../util/subscribeToResult":436}],326:[function(require,module,exports) {
"use strict";
var onErrorResumeNext_1 = require('../operators/onErrorResumeNext');
exports.onErrorResumeNext = onErrorResumeNext_1.onErrorResumeNextStatic;
//# sourceMappingURL=onErrorResumeNext.js.map
},{"../operators/onErrorResumeNext":247}],76:[function(require,module,exports) {
"use strict";
var Observable_1 = require('../../Observable');
var onErrorResumeNext_1 = require('../../observable/onErrorResumeNext');
Observable_1.Observable.onErrorResumeNext = onErrorResumeNext_1.onErrorResumeNext;
//# sourceMappingURL=onErrorResumeNext.js.map
},{"../../Observable":32,"../../observable/onErrorResumeNext":326}],466:[function(require,module,exports) {
"use strict";
var __extends = (this && this.__extends) || function (d, b) {
    for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p];
    function __() { this.constructor = d; }
...
},{"../Observable":32}],327:[function(require,module,exports) {
"use strict";
var PairsObservable_1 = require('./PairsObservable');
exports.pairs = PairsObservable_1.PairsObservable.create;
//# sourceMappingURL=pairs.js.map
},{"./PairsObservable":466}],77:[function(require,module,exports) {
"use strict";
var Observable_1 = require('../../Observable');
var pairs_1 = require('../../observable/pairs');
Observable_1.Observable.pairs = pairs_1.pairs;
//# sourceMappingURL=pairs.js.map
},{"../../Observable":32,"../../observable/pairs":327}],467:[function(require,module,exports) {
"use strict";
var __extends = (this && this.__extends) || function (d, b) {
    for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p];
    function __() { this.constructor = d; }
...
},{"../Observable":32}],328:[function(require,module,exports) {
"use strict";
var RangeObservable_1 = require('./RangeObservable');
exports.range = RangeObservable_1.RangeObservable.create;
//# sourceMappingURL=range.js.map
},{"./RangeObservable":467}],78:[function(require,module,exports) {
"use strict";
var Observable_1 = require('../../Observable');
...
},{"../Subscriber":34}],185:[function(require,module,exports) {
"use strict";
var __extends = (this && this.__extends) || function (d, b) {
    for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p];
    function __() { this.constructor = d; }
...
},{"./AjaxObservable":185}],186:[function(require,module,exports) {
"use strict";
var Observable_1 = require('../../../Observable');
var ajax_1 = require('../../../observable/dom/ajax');
Observable_1.Observable.ajax = ajax_1.ajax;
//# sourceMappingURL=ajax.js.map
},{"../../../Observable":32,"../../../observable/dom/ajax":433}],304:[function(require,module,exports) {
"use strict";
var __extends = (this && this.__extends) || function (d, b) {
    for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p];
    function __() { this.constructor = d; }
...
},{"./QueueAction":304,"./QueueScheduler":305}],36:[function(require,module,exports) {
"use strict";
var __extends = (this && this.__extends) || function (d, b) {
    for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p];
    function __() { this.constructor = d; }
...
},{"./root":190}],472:[function(require,module,exports) {
"use strict";
var __extends = (this && this.__extends) || function (d, b) {
    for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p];
    function __() { this.constructor = d; }
...
},{"../../Subject":31,"../../Subscriber":34,"../../Observable":32,"../../Subscription":33,"../../util/root":190,"../../ReplaySubject":36,"../../util/tryCatch":195,"../../util/errorObject":196,"../../util/assign":480}],434:[function(require,module,exports) {
"use strict";
var WebSocketSubject_1 = require('./WebSocketSubject');
exports.webSocket = WebSocketSubject_1.WebSocketSubject.create;
//# sourceMappingURL=webSocket.js.map
},{"./WebSocketSubject":472}],187:[function(require,module,exports) {
"use strict";
var Observable_1 = require('../../../Observable');
var webSocket_1 = require('../../../observable/dom/webSocket');
Observable_1.Observable.webSocket = webSocket_1.webSocket;
//# sourceMappingURL=webSocket.js.map
},{"../../../Observable":32,"../../../observable/dom/webSocket":434}],200:[function(require,module,exports) {
"use strict";
var __extends = (this && this.__extends) || function (d, b) {
    for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p];
    function __() { this.constructor = d; }
...
exports.buffer = buffer;
//# sourceMappingURL=buffer.js.map
},{"../operators/buffer":200}],83:[function(require,module,exports) {
"use strict";
var Observable_1 = require('../../Observable');
...
},{"../Subscriber":34}],334:[function(require,module,exports) {
"use strict";
...
exports.bufferCount = bufferCount;
//# sourceMappingURL=bufferCount.js.map
},{"../operators/bufferCount":201}],84:[function(require,module,exports) {
"use strict";
var Observable_1 = require('../../Observable');
var bufferCount_1 = require('../../operator/bufferCount');
Observable_1.Observable.prototype.bufferCount = bufferCount_1.bufferCount;
//# sourceMappingURL=bufferCount.js.map
},{"../../Observable":32,"../../operator/bufferCount":334}],202:[function(require,module,exports) {
"use strict";
var __extends = (this && this.__extends) || function (d, b) {
    for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p];
    function __() { this.constructor = d; }
...
exports.bufferTime = bufferTime;
//# sourceMappingURL=bufferTime.js.map
},{"../scheduler/async":52,"../util/isScheduler":437,"../operators/bufferTime":202}],85:[function(require,module,exports) {
"use strict";
var Observable_1 = require('../../Observable');
...
exports.bufferToggle = bufferToggle;
//# sourceMappingURL=bufferToggle.js.map
},{"../operators/bufferToggle":203}],86:[function(require,module,exports) {
"use strict";
var Observable_1 = require('../../Observable');
...
//# sourceMappingURL=concat.js.map
},{"../../Observable":32,"../../operator/concat":341}],342:[function(require,module,exports) {
"use strict";
var concatAll_1 = require('../operators/concatAll');
/* tslint:enable:max-line-length */
/**
...
//# sourceMappingURL=concatAll.js.map
},{"../../Observable":32,"../../operator/concatAll":342}],210:[function(require,module,exports) {
"use strict";
var mergeMap_1 = require('./mergeMap');
/* tslint:enable:max-line-length */
/**
...
},{"./mergeMap":242}],343:[function(require,module,exports) {
"use strict";
...
exports.concatMap = concatMap;
//# sourceMappingURL=concatMap.js.map
},{"../operators/concatMap":210}],93:[function(require,module,exports) {
"use strict";
var Observable_1 = require('../../Observable');
var concatMap_1 = require('../../operator/concatMap');
Observable_1.Observable.prototype.concatMap = concatMap_1.concatMap;
//# sourceMappingURL=concatMap.js.map
},{"../../Observable":32,"../../operator/concatMap":343}],211:[function(require,module,exports) {
"use strict";
...
},{"./concatMap":210}],344:[function(require,module,exports) {
"use strict";
...
exports.concatMapTo = concatMapTo;
//# sourceMappingURL=concatMapTo.js.map
},{"../operators/concatMapTo":211}],94:[function(require,module,exports) {
"use strict";
var Observable_1 = require('../../Observable');
var concatMapTo_1 = require('../../operator/concatMapTo');
Observable_1.Observable.prototype.concatMapTo = concatMapTo_1.concatMapTo;
//# sourceMappingURL=concatMapTo.js.map
},{"../../Observable":32,"../../operator/concatMapTo":344}],212:[function(require,module,exports) {
"use strict";
var __extends = (this && this.__extends) || function (d, b) {
    for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p];
    function __() { this.constructor = d; }
...
},{"../Subscriber":34}],345:[function(require,module,exports) {
"use strict";
...
exports.count = count;
//# sourceMappingURL=count.js.map
},{"../operators/count":212}],95:[function(require,module,exports) {
"use strict";
var Observable_1 = require('../../Observable');
var count_1 = require('../../operator/count');
Observable_1.Observable.prototype.count = count_1.count;
//# sourceMappingURL=count.js.map
},{"../../Observable":32,"../../operator/count":345}],218:[function(require,module,exports) {
"use strict";
var __extends = (this && this.__extends) || function (d, b) {
    for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p];
    function __() { this.constructor = d; }
...
},{"../Subscriber":34}],346:[function(require,module,exports) {
"use strict";
...
exports.dematerialize = dematerialize;
//# sourceMappingURL=dematerialize.js.map
},{"../operators/dematerialize":218}],96:[function(require,module,exports) {
"use strict";
var Observable_1 = require('../../Observable');
var dematerialize_1 = require('../../operator/dematerialize');
Observable_1.Observable.prototype.dematerialize = dematerialize_1.dematerialize;
//# sourceMappingURL=dematerialize.js.map
},{"../../Observable":32,"../../operator/dematerialize":346}],213:[function(require,module,exports) {
"use strict";
var __extends = (this && this.__extends) || function (d, b) {
    for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p];
    function __() { this.constructor = d; }
...
exports.debounce = debounce;
//# sourceMappingURL=debounce.js.map
},{"../operators/debounce":213}],97:[function(require,module,exports) {
"use strict";
var Observable_1 = require('../../Observable');
...
},{"../Subscriber":34}],349:[function(require,module,exports) {
"use strict";
...
},{"../Subscriber":34,"../Observable":32,"../OuterSubscriber":435,"../util/subscribeToResult":436}],351:[function(require,module,exports) {
"use strict";
...
//# sourceMappingURL=delayWhen.js.map
},{"../../Observable":32,"../../operator/delayWhen":351}],440:[function(require,module,exports) {
"use strict";
var root_1 = require('./root');
...
},{"./root":190}],219:[function(require,module,exports) {
"use strict";
var __extends = (this && this.__extends) || function (d, b) {
    for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p];
    function __() { this.constructor = d; }
...
},{"../OuterSubscriber":435,"../util/subscribeToResult":436,"../util/Set":440}],352:[function(require,module,exports) {
"use strict";
...
exports.distinct = distinct;
//# sourceMappingURL=distinct.js.map
},{"../operators/distinct":219}],102:[function(require,module,exports) {
"use strict";
var Observable_1 = require('../../Observable');
var distinct_1 = require('../../operator/distinct');
Observable_1.Observable.prototype.distinct = distinct_1.distinct;
//# sourceMappingURL=distinct.js.map
},{"../../Observable":32,"../../operator/distinct":352}],220:[function(require,module,exports) {
"use strict";
var __extends = (this && this.__extends) || function (d, b) {
    for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p];
    function __() { this.constructor = d; }
...
exports.distinctUntilChanged = distinctUntilChanged;
//# sourceMappingURL=distinctUntilChanged.js.map
},{"../operators/distinctUntilChanged":220}],103:[function(require,module,exports) {
"use strict";
var Observable_1 = require('../../Observable');
...
exports.distinctUntilKeyChanged = distinctUntilKeyChanged;
//# sourceMappingURL=distinctUntilKeyChanged.js.map
},{"../operators/distinctUntilKeyChanged":221}],104:[function(require,module,exports) {
"use strict";
var Observable_1 = require('../../Observable');
...
},{"../Subscriber":34}],355:[function(require,module,exports) {
"use strict";
...
},{"../operators/tap":281}],105:[function(require,module,exports) {
"use strict";
var Observable_1 = require('../../Observable');
...
//# sourceMappingURL=do.js.map
},{"../../Observable":32,"../../operator/do":355}],224:[function(require,module,exports) {
"use strict";
var __extends = (this && this.__extends) || function (d, b) {
    for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p];
    function __() { this.constructor = d; }
...
exports.expand = expand;
//# sourceMappingURL=expand.js.map
},{"../operators/expand":226}],108:[function(require,module,exports) {
"use strict";
var Observable_1 = require('../../Observable');
...
exports.elementAt = elementAt;
//# sourceMappingURL=elementAt.js.map
},{"../operators/elementAt":222}],109:[function(require,module,exports) {
"use strict";
var Observable_1 = require('../../Observable');
...
exports.filter = filter;
//# sourceMappingURL=filter.js.map
},{"../operators/filter":227}],110:[function(require,module,exports) {
"use strict";
var Observable_1 = require('../../Observable');
...
},{"../operators/finalize":228}],111:[function(require,module,exports) {
"use strict";
var Observable_1 = require('../../Observable');
...
},{"../Subscriber":34}],361:[function(require,module,exports) {
"use strict";
...
exports.find = find;
//# sourceMappingURL=find.js.map
},{"../operators/find":229}],112:[function(require,module,exports) {
"use strict";
var Observable_1 = require('../../Observable');
var find_1 = require('../../operator/find');
Observable_1.Observable.prototype.find = find_1.find;
//# sourceMappingURL=find.js.map
},{"../../Observable":32,"../../operator/find":361}],230:[function(require,module,exports) {
"use strict";
var find_1 = require('../operators/find');
/**
...
},{"../operators/find":229}],362:[function(require,module,exports) {
"use strict";
...
exports.findIndex = findIndex;
//# sourceMappingURL=findIndex.js.map
},{"../operators/findIndex":230}],113:[function(require,module,exports) {
"use strict";
var Observable_1 = require('../../Observable');
...
exports.first = first;
//# sourceMappingURL=first.js.map
},{"../operators/first":231}],114:[function(require,module,exports) {
"use strict";
var Observable_1 = require('../../Observable');
var first_1 = require('../../operator/first');
Observable_1.Observable.prototype.first = first_1.first;
//# sourceMappingURL=first.js.map
},{"../../Observable":32,"../../operator/first":363}],476:[function(require,module,exports) {
"use strict";
...
exports.groupBy = groupBy;
//# sourceMappingURL=groupBy.js.map
},{"../operators/groupBy":232}],115:[function(require,module,exports) {
"use strict";
var Observable_1 = require('../../Observable');
...
;
//# sourceMappingURL=ignoreElements.js.map
},{"../operators/ignoreElements":233}],116:[function(require,module,exports) {
"use strict";
var Observable_1 = require('../../Observable');
...
exports.isEmpty = isEmpty;
//# sourceMappingURL=isEmpty.js.map
},{"../operators/isEmpty":234}],117:[function(require,module,exports) {
"use strict";
var Observable_1 = require('../../Observable');
...
exports.every = every;
//# sourceMappingURL=every.js.map
},{"../operators/every":223}],122:[function(require,module,exports) {
"use strict";
var Observable_1 = require('../../Observable');
...
exports.mapTo = mapTo;
//# sourceMappingURL=mapTo.js.map
},{"../operators/mapTo":237}],124:[function(require,module,exports) {
"use strict";
var Observable_1 = require('../../Observable');
...
exports.materialize = materialize;
//# sourceMappingURL=materialize.js.map
},{"../operators/materialize":238}],125:[function(require,module,exports) {
"use strict";
var Observable_1 = require('../../Observable');
...
},{"../Subscriber":34}],278:[function(require,module,exports) {
"use strict";
var __extends = (this && this.__extends) || function (d, b) {
    for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p];
    function __() { this.constructor = d; }
...
exports.mergeAll = mergeAll;
//# sourceMappingURL=mergeAll.js.map
},{"../operators/mergeAll":241}],128:[function(require,module,exports) {
"use strict";
var Observable_1 = require('../../Observable');
...
exports.mergeMap = mergeMap;
//# sourceMappingURL=mergeMap.js.map
},{"../operators/mergeMap":242}],129:[function(require,module,exports) {
"use strict";
var Observable_1 = require('../../Observable');
...
//# sourceMappingURL=mergeMap.js.map
},{"../../Observable":32,"../../operator/mergeMap":379}],243:[function(require,module,exports) {
"use strict";
var __extends = (this && this.__extends) || function (d, b) {
    for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p];
    function __() { this.constructor = d; }
...
},{"../OuterSubscriber":435,"../util/subscribeToResult":436}],380:[function(require,module,exports) {
"use strict";
...
exports.mergeMapTo = mergeMapTo;
//# sourceMappingURL=mergeMapTo.js.map
},{"../operators/mergeMapTo":243}],130:[function(require,module,exports) {
"use strict";
var Observable_1 = require('../../Observable');
...
//# sourceMappingURL=mergeMapTo.js.map
},{"../../Observable":32,"../../operator/mergeMapTo":380}],244:[function(require,module,exports) {
"use strict";
var __extends = (this && this.__extends) || function (d, b) {
    for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p];
    function __() { this.constructor = d; }
...
},{"../util/tryCatch":195,"../util/errorObject":196,"../util/subscribeToResult":436,"../OuterSubscriber":435}],381:[function(require,module,exports) {
"use strict";
...
exports.mergeScan = mergeScan;
//# sourceMappingURL=mergeScan.js.map
},{"../operators/mergeScan":244}],131:[function(require,module,exports) {
"use strict";
var Observable_1 = require('../../Observable');
var mergeScan_1 = require('../../operator/mergeScan');
Observable_1.Observable.prototype.mergeScan = mergeScan_1.mergeScan;
//# sourceMappingURL=mergeScan.js.map
},{"../../Observable":32,"../../operator/mergeScan":381}],245:[function(require,module,exports) {
"use strict";
var reduce_1 = require('./reduce');
/**
...
exports.min = min;
//# sourceMappingURL=min.js.map
},{"../operators/min":245}],132:[function(require,module,exports) {
"use strict";
var Observable_1 = require('../../Observable');
...
},{"../Subscriber":34}],40:[function(require,module,exports) {
"use strict";
var __extends = (this && this.__extends) || function (d, b) {
    for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p];
    function __() { this.constructor = d; }
...
exports.multicast = multicast;
//# sourceMappingURL=multicast.js.map
},{"../operators/multicast":246}],133:[function(require,module,exports) {
"use strict";
var Observable_1 = require('../../Observable');
...
exports.observeOn = observeOn;
//# sourceMappingURL=observeOn.js.map
},{"../operators/observeOn":197}],134:[function(require,module,exports) {
"use strict";
var Observable_1 = require('../../Observable');
...
exports.onErrorResumeNext = onErrorResumeNext;
//# sourceMappingURL=onErrorResumeNext.js.map
},{"../operators/onErrorResumeNext":247}],135:[function(require,module,exports) {
"use strict";
var Observable_1 = require('../../Observable');
...
},{"../Subject":31,"./multicast":246}],389:[function(require,module,exports) {
"use strict";
...
//# sourceMappingURL=publish.js.map
},{"../../Observable":32,"../../operator/publish":389}],37:[function(require,module,exports) {
"use strict";
var __extends = (this && this.__extends) || function (d, b) {
    for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p];
    function __() { this.constructor = d; }
...
},{"../BehaviorSubject":37,"./multicast":246}],390:[function(require,module,exports) {
"use strict";
...
},{"../ReplaySubject":36,"./multicast":246}],391:[function(require,module,exports) {
"use strict";
...
//# sourceMappingURL=publishReplay.js.map
},{"../../Observable":32,"../../operator/publishReplay":391}],253:[function(require,module,exports) {
"use strict";
var AsyncSubject_1 = require('../AsyncSubject');
var multicast_1 = require('./multicast');
...
exports.publishLast = publishLast;
//# sourceMappingURL=publishLast.js.map
},{"../operators/publishLast":253}],142:[function(require,module,exports) {
"use strict";
var Observable_1 = require('../../Observable');
...
},{"../ReplaySubject":36}],404:[function(require,module,exports) {
"use strict";
...
},{"../OuterSubscriber":435,"../util/subscribeToResult":436}],408:[function(require,module,exports) {
"use strict";
...
},{"../Subscriber":34}],409:[function(require,module,exports) {
"use strict";
...
},{"../Observable":32,"../scheduler/asap":51,"../util/isNumeric":448}],471:[function(require,module,exports) {
"use strict";
...
},{"../OuterSubscriber":435,"../util/subscribeToResult":436}],414:[function(require,module,exports) {
"use strict";
...
//# sourceMappingURL=take.js.map
},{"../../Observable":32,"../../operator/take":415}],416:[function(require,module,exports) {
"use strict";
...
exports.takeLast = takeLast;
//# sourceMappingURL=takeLast.js.map
},{"../operators/takeLast":278}],166:[function(require,module,exports) {
"use strict";
var Observable_1 = require('../../Observable');
...
exports.takeWhile = takeWhile;
//# sourceMappingURL=takeWhile.js.map
},{"../operators/takeWhile":280}],168:[function(require,module,exports) {
"use strict";
var Observable_1 = require('../../Observable');
...
},{"../Subscriber":34,"../scheduler/async":52}],46:[function(require,module,exports) {
"use strict";
var async_1 = require('../scheduler/async');
...
exports.timeInterval = timeInterval;
//# sourceMappingURL=timeInterval.js.map
},{"../scheduler/async":52,"../operators/timeInterval":284}],171:[function(require,module,exports) {
"use strict";
var Observable_1 = require('../../Observable');
...
exports.timeout = timeout;
//# sourceMappingURL=timeout.js.map
},{"../scheduler/async":52,"../operators/timeout":285}],172:[function(require,module,exports) {
"use strict";
var Observable_1 = require('../../Observable');
...
exports.timeoutWith = timeoutWith;
//# sourceMappingURL=timeoutWith.js.map
},{"../scheduler/async":52,"../operators/timeoutWith":286}],173:[function(require,module,exports) {
"use strict";
var Observable_1 = require('../../Observable');
...
exports.timestamp = timestamp;
//# sourceMappingURL=timestamp.js.map
},{"../scheduler/async":52,"../operators/timestamp":47}],174:[function(require,module,exports) {
"use strict";
var Observable_1 = require('../../Observable');
var timestamp_1 = require('../../operator/timestamp');
Observable_1.Observable.prototype.timestamp = timestamp_1.timestamp;
//# sourceMappingURL=timestamp.js.map
},{"../../Observable":32,"../../operator/timestamp":423}],287:[function(require,module,exports) {
"use strict";
var reduce_1 = require('./reduce');
...
exports.window = window;
//# sourceMappingURL=window.js.map
},{"../operators/window":288}],177:[function(require,module,exports) {
"use strict";
var Observable_1 = require('../../Observable');
...
exports.windowCount = windowCount;
//# sourceMappingURL=windowCount.js.map
},{"../operators/windowCount":289}],178:[function(require,module,exports) {
"use strict";
var Observable_1 = require('../../Observable');
...
},{"../Subject":31,"../scheduler/async":52,"../Subscriber":34,"../util/isNumeric":448,"../util/isScheduler":437}],427:[function(require,module,exports) {
"use strict";
var async_1 = require('../scheduler/async');
var isNumeric_1 = require('../util/isNumeric');
var isScheduler_1 = require('../util/isScheduler');
...
exports.windowTime = windowTime;
//# sourceMappingURL=windowTime.js.map
},{"../scheduler/async":52,"../util/isNumeric":448,"../util/isScheduler":437,"../operators/windowTime":290}],179:[function(require,module,exports) {
"use strict";
var Observable_1 = require('../../Observable');
var windowTime_1 = require('../../operator/windowTime');
Observable_1.Observable.prototype.windowTime = windowTime_1.windowTime;
//# sourceMappingURL=windowTime.js.map
},{"../../Observable":32,"../../operator/windowTime":427}],291:[function(require,module,exports) {
"use strict";
var __extends = (this && this.__extends) || function (d, b) {
    for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p];
    function __() { this.constructor = d; }
...
exports.windowToggle = windowToggle;
//# sourceMappingURL=windowToggle.js.map
},{"../operators/windowToggle":291}],180:[function(require,module,exports) {
"use strict";
var Observable_1 = require('../../Observable');
...
exports.zipAll = zipAll;
//# sourceMappingURL=zipAll.js.map
},{"../operators/zipAll":295}],184:[function(require,module,exports) {
"use strict";
var Observable_1 = require('../../Observable');
...
},{"./root":190}],306:[function(require,module,exports) {
"use strict";
var __extends = (this && this.__extends) || function (d, b) {
    for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p];
    function __() { this.constructor = d; }
...
//# sourceMappingURL=animationFrame.js.map
},{"./AnimationFrameAction":306,"./AnimationFrameScheduler":307}],39:[function(require,module,exports) {
"use strict";
var audit_1 = require('./operators/audit');
...
var ImageLoader = function () {
    function ImageLoader() {
        ...
        this.cache = new _1.Cache();
    }
    ImageLoader.prototype.load = function (url, onLoad, onError) {
        var _this = this;
        var src = this.path ? this.path + url : url;
        var observable = rxjs_1.Observable.create(function (observer) {
            if (_this.cache.has(src)) {
                setTimeout(function () {
                    observer.next(_this.cache.get(src));
                    observer.complete();
                }, 0);
                return;
            }
            _this.loadImage(src, observer);
        });
        return observable;
    };
    ...
    ImageLoader.prototype.loadImage = function (src, observer) {
        var _this = this;
        var image = document.createElementNS('http://www.w3.org/1999/xhtml', 'img');
        rxjs_1.Observable.fromEvent(image, 'load').subscribe(function () {
            _this.cache.add(src, image);
            observer.next(image);
            observer.complete();
        });
        rxjs_1.Observable.fromEvent(image, 'error').subscribe(function (event) {
...
var Perf = function () {
    function Perf() {}
    Perf.timeStart = function (label) {
        console.time(label);
    };
    Perf.timeEnd = function (label) {
...
var _1 = require(".");
var common_1 = require("../common");
var CVImage_1 = require("../CVImage");
var utils_1 = require("../utils");
function channel(image, type, presentFlag) {
    var cvImage = new CVImage_1.default(image);
    utils_1.Perf.timeStart("CHANNEL: " + type + ", " + presentFlag);
    cvImage.convolve(splitChannel(type, presentFlag));
    utils_1.Perf.timeEnd("CHANNEL: " + type + ", " + presentFlag);
    return cvImage.canvas;
}
exports.channel = channel;
function splitChannel(type, presentFlag) {
    return function (pixel) {
        var brightness = getChannelBrightness(type, pixel);
        var a = pixel.a;
        var r;
        var g;
        var b;
        if (_1.CHANNEL_PRESENT_FLAG.SINGLE === presentFlag) {
            r = type === _1.CHANNEL_TYPE.RED ? brightness : 0;
            g = type === _1.CHANNEL_TYPE.GREEN ? brightness : 0;
            b = type === _1.CHANNEL_TYPE.BLUE ? brightness : 0;
        } else {
            r = brightness;
            g = brightness;
            b = brightness;
...
function getChannelBrightness(type, _a) {
    var r = _a.r,
        g = _a.g,
        b = _a.b,
        a = _a.a;
    switch (type) {
        case _1.CHANNEL_TYPE.RED:
            return r;
        case _1.CHANNEL_TYPE.GREEN:
            return g;
        case _1.CHANNEL_TYPE.BLUE:
            return b;
        default:
...
var CVImage_1 = require("../../CVImage");
var utils_1 = require("../../utils");
function averaging(image, kernelSize) {
    var cvImage = new CVImage_1.default(image);
    utils_1.Perf.timeStart("AVERAGING_FILTERING");
    cvImage.kernelConvolve(action, kernelSize, getWeights(kernelSize));
    utils_1.Perf.timeEnd("AVERAGING_FILTERING");
    return cvImage.canvas;
}
exports.averaging = averaging;
function action(pixel, kernel, kernelSize, weights) {
    var _a = kernel.reduce(function (avgBrightnesses, p, cIdx) {
        var pixelBrightnesses = [p.r, p.g, p.b];
        return [0, 1, 2].map(function (idx) {
            return avgBrightnesses[idx] + pixelBrightnesses[idx] * weights[cIdx];
        });
    }, [0, 0, 0]),
        r = _a[0],
        g = _a[1],
...
function getWeights(kernelSize) {
    if (kernelSize % 2 === 0) {
        common_1.err('Invalid kernelSize');
    }
    var kSize = kernelSize * kernelSize;
    return Array(kSize).slice().fill(1 / kSize);
}
exports.getWeights = getWeights;
},{"../../common":4,"../../CVImage":20,"../../utils":9}],23:[function(require,module,exports) {
"use strict";
...
var CVImage_1 = require("../../CVImage");
var utils_1 = require("../../utils");
function gaussian(image, kernelSize, sigma) {
    if (sigma === void 0) {
        sigma = 0;
    }
    var cvImage = new CVImage_1.default(image);
    utils_1.Perf.timeStart("GAUSSIAN_FILTERING");
    cvImage.kernelConvolve(action, kernelSize, getWeights(kernelSize, sigma));
    utils_1.Perf.timeEnd("GAUSSIAN_FILTERING");
    return cvImage.canvas;
}
...
function getWeights(kernelSize, sigma) {
    if (kernelSize % 2 === 0) {
        common_1.err('Invalid kernelSize');
    }
    var s = sigma !== 0 ? sigma : getSigma(kernelSize);
    var kernel = [];
    var origin = Math.floor(kernelSize >> 1);
...
var CVImage_1 = require("../../CVImage");
var utils_1 = require("../../utils");
function median(image, kernelSize) {
    var cvImage = new CVImage_1.default(image);
    utils_1.Perf.timeStart("MEDIAN_FILTERING");
    cvImage.kernelConvolve(action, kernelSize);
    utils_1.Perf.timeEnd("MEDIAN_FILTERING");
    return cvImage.canvas;
}
exports.median = median;
function action(pixel, kernel, kernelSize) {
...
Object.defineProperty(exports, "__esModule", { value: true });
var averaging = require("./averaging");
exports.averaging = averaging;
...
Object.defineProperty(exports, "__esModule", { value: true });
var GRAYSCALE_TYPE;
(function (GRAYSCALE_TYPE) {
    GRAYSCALE_TYPE[GRAYSCALE_TYPE["AVERAGE"] = 0] = "AVERAGE";
    GRAYSCALE_TYPE[GRAYSCALE_TYPE["YUV"] = 1] = "YUV";
    GRAYSCALE_TYPE[GRAYSCALE_TYPE["HSL"] = 2] = "HSL";
...
function grayscale(image, type) {
    var cvImage = new CVImage_1.default(image);
    switch (type) {
        case _1.GRAYSCALE_TYPE.AVERAGE:
            utils_1.Perf.timeStart("GRAYSCALE: " + type);
            cvImage.convolve(convolveByAverage);
            utils_1.Perf.timeEnd("GRAYSCALE: " + type);
            break;
        case _1.GRAYSCALE_TYPE.YUV:
            utils_1.Perf.timeStart("GRAYSCALE: " + type);
            cvImage.convolve(convolveByYUV);
            utils_1.Perf.timeEnd("GRAYSCALE: " + type);
            break;
        case _1.GRAYSCALE_TYPE.HSL:
            utils_1.Perf.timeStart("GRAYSCALE: " + type);
            cvImage.convolve(convolveByHSL);
            utils_1.Perf.timeEnd("GRAYSCALE: " + type);
            break;
        case _1.GRAYSCALE_TYPE.HSV:
            utils_1.Perf.timeStart("GRAYSCALE: " + type);
            cvImage.convolve(convolveByHSV);
            utils_1.Perf.timeEnd("GRAYSCALE: " + type);
            break;
        case _1.GRAYSCALE_TYPE.HSI:
            utils_1.Perf.timeStart("GRAYSCALE: " + type);
...
function convolveByHSL(_a) {
    var r = _a.r,
        g = _a.g,
        b = _a.b,
        a = _a.a;
    var brightness = (Math.max(r, g, b) + Math.min(r, g, b)) * 0.5;
    return {
        a: a,
        r: brightness,
        g: brightness,
...
},{".":7,"../CVImage":20,"../utils":9}],7:[function(require,module,exports) {
"use strict";
...
var MERGE_TYPE;
(function (MERGE_TYPE) {
    MERGE_TYPE[MERGE_TYPE["REMAINDER"] = 0] = "REMAINDER";
...
function merge(image1, image2, type, weight1, weight2) {
    var cvImage1 = new CVImage_1.default(image1);
    var cvImage2 = new CVImage_1.default(image2);
    switch (type) {
        case _1.MERGE_TYPE.REMAINDER:
            utils_1.Perf.timeStart("MERGE_TYPE: " + type);
            cvImage1.multiConvolve(cvImage2, remainderMerge);
            utils_1.Perf.timeEnd("MERGE_TYPE: " + type);
            break;
        case _1.MERGE_TYPE.MIN:
            utils_1.Perf.timeStart("MERGE_TYPE: " + type);
            cvImage1.multiConvolve(cvImage2, minMerge);
            utils_1.Perf.timeEnd("MERGE_TYPE: " + type);
            break;
        case _1.MERGE_TYPE.WEIGHT:
            utils_1.Perf.timeStart("MERGE_TYPE: " + type);
...
exports.merge = merge;
function remainderMerge(pixel1, pixel2) {
    if (!pixel2) {
        return pixel1;
    }
    return {
...
function minMerge(pixel1, pixel2) {
    if (!pixel2) {
        return pixel1;
    }
    return {
...
function weightMerge(pixel1, pixel2, weight1, weight2) {
    if (!pixel2) {
        return pixel1;
    }
    return {
...
(function (METHOD_TYPE) {
    METHOD_TYPE[METHOD_TYPE["CONVOLVE"] = 0] = "CONVOLVE";
...
var WorkerHelper = function () {
    function WorkerHelper(worker) {
        this.worker = worker;
    }
    WorkerHelper.prototype.postMessage = function (msg, transferList) {
        this.worker.postMessage(JSON.stringify(msg), transferList);
    };
    WorkerHelper.prototype.addEventListener = function (type, listener, useCapture) {
        this.worker.addEventListener(type, listener, useCapture);
    };
    WorkerHelper.prototype.removeEventListener = function (type, listener, useCapture) {
...
var WorkerLoader = function () {
    function WorkerLoader(stringUrl, loaded) {
        ...
        if (!WorkerLoader.useWorker) {
            common_1.err('Do not support worker');
        }
        if (!stringUrl) {
            common_1.err('Invalid stringUrl');
        }
        if (cache.has(stringUrl)) {
            var loader = cache.get(stringUrl);
            loaded(loader);
            return loader;
        }
        fetch(stringUrl).catch(function (reason) {
            return common_1.err(reason);
        }).then(function (data) {
            return data.blob();
        }).then(function (blob) {
            _this.isLoaded = true;
    ...
    Object.defineProperty(WorkerLoader, "useWorker", {
        get: function get() {
...
var grayscale = require("./grayscale");
